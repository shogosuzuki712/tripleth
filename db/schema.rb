...
ActiveRecord::Schema.define(version: 2021_06_22_145723) do
  ...
  create_table "diet_menus", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.integer "genre_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_diet_menus_on_user_id"
  end
  ...
  add_foreign_key "diet_menus", "users"
